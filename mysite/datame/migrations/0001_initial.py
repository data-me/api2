# Generated by Django 2.1 on 2019-04-02 10:39
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('FREE', 'FREE'), ('PRO', 'PRO')], max_length=4, verbose_name='Type')),
                ('expirationDate', models.DateTimeField(blank=True)),
                ('DataScientist', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='datame.DataScientist')),
            ],
        ),
        migrations.AddField(
            model_name='section',

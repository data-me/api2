...
def populate(request):
    try:
        ...
        offer1 = Offer.objects.create(title='Offer1',description='this is the offer 1',price_offered =1000,
                                      creation_date=datetime.datetime.utcnow(),limit_time = datetime.datetime(2019,7,12,21,0,0,0,pytz.UTC), finished = False, files = 'www.github.com',company= company01)
        offer2 = Offer.objects.create(title='Offer2',description='this is the offer 2',price_offered =1350,
                                      creation_date=datetime.datetime.utcnow(),limit_time = datetime.datetime(2019,4,1,10,0,0,0,pytz.UTC), finished = True, files = 'www.github.com/Datame',company= company01)
        offer3 = Offer.objects.create(title='Offer3',description='this is the offer 3',price_offered =3100,
                                      creation_date=datetime.datetime.utcnow(),limit_time = datetime.datetime(2019,9,12,10,0,0,0,pytz.UTC), finished = False, files = 'www.github.com/Datame',company= company01)
        offer4 = Offer.objects.create(title='Offer4',description='this is the offer 4',price_offered =200,
                                      creation_date=datetime.datetime.utcnow(),limit_time = datetime.datetime(2019,9,12,10,0,0,0,pytz.UTC), finished = False, files = 'www.github.com/Datame',company= company02)
        offer5 = Offer.objects.create(title='Offer5',description='this is the offer 5',price_offered =450,
                                      creation_date=datetime.datetime.utcnow(),limit_time = datetime.datetime(2020,3,2,10,0,0,0,pytz.UTC), finished = False, files = 'www.github.com/Datame',company= company02)
